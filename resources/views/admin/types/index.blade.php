...
@section('title', 'Types de réclamations')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">
            {{ $types->count() }} type(s) de réclamation enregistré(s)
        </p>
    </div>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="type-icon me-3" 
                                             style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 10px; background: linear-gradient(135deg, #6f42c1, #4a1a8a); color: white; flex-shrink: 0;">
                                            <i class="mdi mdi-tag" style="font-size: 20px;"></i>
                                        </div>
                                        <div>
                                ...
                                <td>
                                    @if($type->unit)
                                        ...
                                        <span class="badge text-black px-3 py-2 rounded-pill">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <form action="{{ route('admin.types.destroy', $type) }}"
                                            ...
                                            <button class="btn btn-sm btn-outline-danger rounded-pill px-3"
                                                    onclick="return confirm('Supprimer définitivement ce type de réclamation ? Les tickets associés seront affectés.')"
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    <div class="d-flex flex-column align-items-center">
                                        <i class="mdi mdi-tag-off text-muted" style="font-size: 48px;"></i>
                                        <p class="text-muted mt-3 mb-0">Aucun type de réclamation enregistré.</p>
                                        <a href="{{ route('admin.types.create') }}" class="btn btn-primary btn-sm mt-2 rounded-pill">
                                            <i class="mdi mdi-plus me-1"></i> Ajouter un type
                                        </a>
                                    </div>
                                </td>
                            </tr>
...
<style>
    ...
    .type-icon {
        ...
        border-radius: 10px;
        background: linear-gradient(135deg, #6f42c1, #4a1a8a);
        color: white;
        flex-shrink: 0;
    }
