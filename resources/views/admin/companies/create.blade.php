...
@section('title', 'Créer une entreprise sous-traitante')
...
<div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
    <div>
        <h3 class="mb-0 fw-bold" style="color: #1e293b;">
            <i class="mdi mdi-handshake-plus me-2" style="color: #6f42c1;"></i>
            Créer une entreprise sous-traitante
        </h3>
        <p class="text-muted small mb-0">
            Ajoutez une nouvelle entreprise pour les transferts de tickets
        </p>
    </div>
